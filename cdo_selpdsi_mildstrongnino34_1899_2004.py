...
# print "cdo sub rub"+number+".nc b.e11.BLMTRC5CN.f19_g16."+number+".cam.h0.PSL.084912-200412_jjamean_ymonmean.nc psl"+number+"_jjamean_mildstrongnino34.nc"
 ...
 print "cdo sub rub"+number+".nc b.e11.BLMTRC5CN.f19_g16."+number+".cam.h0.TS.084912-200412_djfmean_1899-2003_ymonmean.nc sst"+number+"_djfmean_mildstrongnino34_1899-2003.nc"
